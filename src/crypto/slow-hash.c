...
STATIC INLINE int force_software_aes(void)
{
  ...
  const char *env = getenv("INVESTCOIN_USE_SOFTWARE_AES");
  if (!env) {
    use = 0;
  }
 ...
 * function outside of Investcoin without caution!  This version uses the hardware
...
/**
 * @brief the hash function implementing CryptoNight, used for the Investcoin proof-of-work
 *
