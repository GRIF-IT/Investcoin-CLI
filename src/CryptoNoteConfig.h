...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x166df9; // addresses start with "K"
const uint64_t CRYPTONOTE_TX_PROOF_BASE58_PREFIX             = 0x369488; // starts with "Proof..."
const uint64_t CRYPTONOTE_RESERVE_PROOF_BASE58_PREFIX        = 0xa74ad1d14; //  starts with "RsrvPrf..."
const uint64_t CRYPTONOTE_KEYS_SIGNATURE_BASE58_PREFIX       = 0xa7f2119; // starts with "SigV1..."
...
const uint64_t MAX_TRANSACTION_SIZE_LIMIT                    = CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_CURRENT * 25;
...
const size_t   DIFFICULTY_WINDOW_V4                          = EXPECTED_NUMBER_OF_BLOCKS_PER_DAY; // blocks
...
const size_t   FUSION_TX_MAX_SIZE                            = CRYPTONOTE_BLOCK_GRANTED_FULL_REWARD_ZONE_V2;
const size_t   FUSION_TX_MIN_INPUT_COUNT                     = 12;
const size_t   FUSION_TX_MIN_IN_OUT_COUNT_RATIO              = 4;

const uint32_t UPGRADE_HEIGHT_V2                             = 11900;  // Block v2, pre-LWMA
const uint32_t UPGRADE_HEIGHT_V3                             = 12000; // Block v3, LWMA1
const uint32_t UPGRADE_HEIGHT_V3_1                           = 12050; // Min fee v2, cap max mixin
const uint32_t UPGRADE_HEIGHT_V4                             = 12100; // Block v4, LWMA2, adaptive min fee, min mixin, disable slave merge mining
const uint32_t UPGRADE_HEIGHT_V4_1                           = 30900; // LWMA3
const uint32_t UPGRADE_HEIGHT_V4_2                           = 33000; // Fee per-byte for extra, ban unmixable denominations
const uint32_t UPGRADE_HEIGHT_V5                             = 35000; // Block v5, back to LWMA1+
...
const char     DNS_CHECKPOINTS_HOST[]                        = "node1.investcoin.pro";
...
const char* const SEED_NODES[] = { 
   "node1.investcoin.pro:5333",
   "node2.investcoin.pro:5333",
   "node3.investcoin.pro:5333",
   "node4.investcoin.pro:5333",
   "node5.investcoin.pro:5333",
   "explorer.investcoin.pro:5333",
   "pool.investcoin.pro:5333"
};
